...
const Sidebar = () => {
  ...
  const linkStyle = (path) =>
    isActive(path) ? 'font-bold text-white bg-[#2d81ca]' : 'font-bold text-white';
      ...
      <div className="flex h-full w-[300px] flex-col rounded-l-2xl text-white p-[16px]">
        <div className="flex h-full w-[225px] flex-col rounded-l-2xl bg-[#42a7ff] pt-[24px] text-white sticky top-0">
          <div>
            ...
            <Link to="/addinterviewer">
              <div className={`mb-0 flex items-center pl-[15px] h-[58px] ${linkStyle('/addinterviewer')}`}>
                <img src={pen} alt="Icon" className="mr-2 h-[24px] opacity-70" />
                <h1 className="font-bold">Add Interviewer</h1>
              </div>
            </Link>
          ...
          {/* Bottom Section */}
          <div onClick={handleLogout} className="mb-6 flex items-center pl-[15px] cursor-pointer">
